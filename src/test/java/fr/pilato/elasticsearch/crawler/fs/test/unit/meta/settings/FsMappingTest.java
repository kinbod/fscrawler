...
public class FsMappingTest extends AbstractFSCrawlerTestCase {
    ...
    @Test
    public void fsMappingForFilesVersion6() throws Exception {
        String mapping = FsCrawlerUtil.readJsonFile(rootTmpDir, metadataDir, "6", FsCrawlerUtil.INDEX_TYPE_DOC);
        logger.info("Mapping used for files v6 : " + mapping);
        assertThat(mapping, is("{\n" +
                "  \"properties\" : {\n" +
                "    \"attachment\" : {\n" +
                "      \"type\" : \"binary\",\n" +
    ...
    @Test
    public void fsMappingForFoldersVersion6() throws Exception {
        String mapping = FsCrawlerUtil.readJsonFile(rootTmpDir, metadataDir, "6", FsCrawlerUtil.INDEX_TYPE_FOLDER);
        logger.info("Mapping used for folders v6 : " + mapping);
        assertThat(mapping, is("{\n" +
                "  \"properties\" : {\n" +
                "    \"real\" : {\n" +
                "      \"type\" : \"keyword\",\n" +
    ...
    @Test
    public void fsMappingForFilesForSpecificJobVersion6() throws Exception {
        String mapping = FsCrawlerUtil.readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "6", FsCrawlerUtil.INDEX_TYPE_DOC);
        logger.info("Mapping used for files v6 : " + mapping);
        assertThat(mapping, is("{\n" +
    ...
    @Test
    public void fsMappingForFoldersForSpecificJobVersion6() throws Exception {
        String mapping = FsCrawlerUtil.readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "6", FsCrawlerUtil.INDEX_TYPE_FOLDER);
        logger.info("Mapping used for folders v6 : " + mapping);
        assertThat(mapping, is("{\n" +
    ...
    @Test
    public void fsIndexSettingsForSpecificJobVersion6() throws Exception {
        String mapping = FsCrawlerUtil.readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "6", FsCrawlerUtil.INDEX_SETTINGS_FILE);
        logger.info("Settings used for index v6 : " + mapping);
        assertThat(mapping, is("{\n" +
