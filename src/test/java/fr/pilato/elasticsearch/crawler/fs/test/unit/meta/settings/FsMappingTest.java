...
public class FsMappingTest extends AbstractFSCrawlerTestCase {
    ...
    @Test
    public void fsSettingsForDocVersion1() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(rootTmpDir, metadataDir, "1", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
        logger.info("Settings used for doc index v1 : " + settings);
    ...
    @Test
    public void fsSettingsForFolderVersion1() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(rootTmpDir, metadataDir, "1", FsCrawlerUtil.INDEX_SETTINGS_FOLDER_FILE);
        logger.info("Settings used for folder index v1 : " + settings);
        assertThat(settings, is("{\n" +
                "  \"settings\": {\n" +
                "    \"analysis\": {\n" +
                "      \"analyzer\": {\n" +
    ...
    @Test
    public void fsSettingsForDocSpecificJobVersion1() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "1", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
        assertThat(settings, is("{\n" +
    ...
    @Test
    public void fsSettingsForFolderSpecificJobVersion1() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "1", FsCrawlerUtil.INDEX_SETTINGS_FOLDER_FILE);
        assertThat(settings, is("{\n" +
    ...
    public void fsSettingsForDocVersion2() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(rootTmpDir, metadataDir, "2", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
    ...
    public void fsSettingsForDocSpecificJobVersion2() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "2", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
        assertThat(settings, is("{\n" +
    ...
    public void fsSettingsForDocVersion5() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(rootTmpDir, metadataDir, "5", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
    ...
    public void fsSettingsForDocSpecificJobVersion5() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "5", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
        assertThat(settings, is("{\n" +
    ...
    public void fsSettingsForDocVersion6() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(rootTmpDir, metadataDir, "6", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
    ...
    public void fsSettingsForDocSpecificJobVersion6() throws Exception {
        String settings = FsCrawlerUtil.readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "6", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
        assertThat(settings, is("{\n" +
                "  // This is a doc mapping version 6\n" +
                "}\n"));
    }
    ...
    public void fsSettingsForFolderSpecificJobVersion6() throws Exception {
        ...
        assertThat(settings, is("{\n" +
                "  // This is a folder mapping version 6\n" +
                "}\n"));
    }
    ...
    public void fsSettingsForDocVersionNotSupported() throws Exception {
        try {
            FsCrawlerUtil.readJsonFile(rootTmpDir, metadataDir, "0", FsCrawlerUtil.INDEX_SETTINGS_DOC_FILE);
